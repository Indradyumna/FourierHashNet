...
if __name__ == "__main__":
    ...
    fp = f"{conf.base_dir}allPklDumps/hashResultPickles/{conf.dataset.name}_{conf.dataset.rel_mode}_{conf.hashing.FUNC}_{conf.hashing.name}_{conf.hashcode_training.LOSS_TYPE}{conf.hashcode_training.QA_subset_size }.pkl"
...
# python -m scripts.lsh_scripts.hashing_baselines dataset.name="msweb294" dataset.rel_mode="fhash"  hashing.FUNC="sighinge" hashing.name="RH_Trained" hashcode_training.QA_subset_size=8 hashcode_training.LOSS_TYPE="query_aware"
# python -m scripts.lsh_scripts.hashing_baselines dataset.name="msweb294" dataset.rel_mode="fhash"  hashing.FUNC="sighinge" hashing.name="DPRH_Trained" hashcode_training.QA_subset_size=8 hashcode_training.LOSS_TYPE="query_aware"


# python -m scripts.lsh_scripts.hashing_baselines dataset.name="msweb294" dataset.rel_mode="fhash"  hashing.FUNC="cos" hashing.name="RH_Trained" hashcode_training.QA_subset_size=8 hashcode_training.LOSS_TYPE="query_aware"
# python -m scripts.lsh_scripts.hashing_baselines dataset.name="msweb294" dataset.rel_mode="fhash"  hashing.FUNC="dot" hashing.name="DPRH_Trained" hashcode_training.QA_subset_size=8 hashcode_training.LOSS_TYPE="query_aware"
